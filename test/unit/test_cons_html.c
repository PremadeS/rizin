...
bool test_cons_to_html() {
	...
	html = rz_cons_html_filter(cons, "\x1b[32mhello\x1b[0m", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[31mhello\x1b[0mabc", NULL);
	mu_assert_streq_free(html, "<font color='#f00'>hello</font>abc", "Simple font color2");

	html = rz_cons_html_filter(cons, "\x1b[31mhe\x1b[44mllo\x1b[0mabc", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[44mhe\x1b[31mllo\x1b[0mabc", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[33m0x0005d01\x1b[0m \x1b[36mand\x1b[36m foo", NULL);
	mu_assert_streq_free(html, "<font color='#ff0'>0x0005d01</font>&nbsp;<font color='#aaf'>and</font><font color='#aaf'>&nbsp;foo</font>", "Space and reset");

	html = rz_cons_html_filter(cons, "\x1b[33mAAAA\x1b[7mBBBB\x1b[33mBBB\x1b[0mCCC", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[33mAAAA\x1b[7mBBBB\x1b[33mBBB\x1b[27mCCC", NULL);
	mu_assert_streq_free(html, "<font color='#ff0'>AAAA</font>"
				   "<font color='#ff0' style='text-decoration:underline overline'>BBBB</font>"
				   "<font color='#ff0' style='text-decoration:underline overline'>BBB</font><font color='#ff0'>CCC</font>",
		"Invert rest");

	html = rz_cons_html_filter(cons, "\x1b[41m\x1b[31mBB\x1b[39mCC", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[41m\x1b[31mBB\x1b[49mCC", NULL);
	...
	html = rz_cons_html_filter(cons, "aaa" Color_RESET "bbb", NULL);
	mu_assert_streq_free(html, "aaabbb", "Only reset");

	html = rz_cons_html_filter(cons, "aaa" Color_RESET Color_RED "bbb", NULL);
	mu_assert_streq_free(html, "aaa<font color='#f00'>bbb</font>", "Color after reset");

	html = rz_cons_html_filter(cons, "aaa" Color_RESET Color_RED Color_RESET "bbb", NULL);
	mu_assert_streq_free(html, "aaabbb", "Color after reset");

	html = rz_cons_html_filter(cons, "aaa" Color_RESET Color_RED Color_RESET Color_BGGREEN "bbb", NULL);
	mu_assert_streq_free(html, "aaa<font style='background-color:#0f0'>bbb</font>", "Reset color reset color");

	html = rz_cons_html_filter(cons, Color_RED Color_BGGREEN "aaa" Color_RESET Color_RESET_BG "bbb", NULL);
	mu_assert_streq_free(html, "<font color='#f00' style='background-color:#0f0'>aaa</font>bbb", "Two different resets");

	html = rz_cons_html_filter(cons, Color_RED Color_BGGREEN "aaa" Color_RESET_BG Color_RESET "bbb", NULL);
	...
	html = rz_cons_html_filter(cons, "\x1b[91mAA\x1b[39mBB", NULL);
	mu_assert_streq_free(html,
		"<font color='#ff5555'>AA</font>BB",
		"Reset bright foreground");

	html = rz_cons_html_filter(cons, "\x1b[91m\x1b[42mAA\x1b[39mBB", NULL);
	mu_assert_streq_free(html,
	...
	html = rz_cons_html_filter(cons, "\x1b[101mAA\x1b[49mBB", NULL);
	mu_assert_streq_free(html,
		"<font style='background-color:#ff5555'>AA</font>BB",
		"Reset bright background");

	html = rz_cons_html_filter(cons, "\x1b[91m\x1b[101mAA\x1b[49mBB", NULL);
	mu_assert_streq_free(html,
