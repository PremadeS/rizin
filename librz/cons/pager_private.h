...
// TODOe: can we do this??
// TODOe: maybe move to rz_cons.h itself?? but remember only one func uses cons.. the (printpage one)
// so we could possible just move that to cons..
