...
static void flag_print(RzCons *cons, RzFlag *f, RzCmdStateOutput *state, ut64 range_from, ut64 range_to, bool in_range) {
	rz_return_if_fail(f);
...
RZ_IPI void rz_core_flag_range_print(RzCons *cons, RzFlag *f, RzCmdStateOutput *state, ut64 range_from, ut64 range_to) {
